...
result_data['type1'] = ['한 우물만 파는 당신,','클래식 텀블러']
result_data['type2'] = ['언제나 새로움을 추구하는 당신,','카멜레온 텀블러']
result_data['type3'] = ['언제나 핫한 당신,','핫!뜨거 텀블러']
result_data['type4'] = ['언제 어디서나 쿨한 당신,','앗!차거 텀블러']
