...
db.type.insert_one({'type1': ['한 우물만 파는 당신,','클래식 텀블러']})
db.type.insert_one({'type2': ['언제나 새로움을 추구하는 당신,','카멜레온 텀블러']})
db.type.insert_one({'type3': ['언제나 핫한 당신,','핫!뜨거 텀블러']})
db.type.insert_one({'type4': ['언제 어디서나 쿨한 당신,','앗!차거 텀블러']})
db.type.insert_one({'type5': ['오지에 가도 살아남을 당신,','all in one 텀블러']})
db.type.insert_one({'type6': ['의자와 물아일체된 당신,','망부석 텀블러']})
db.type.insert_one({'type7': ['환경을 두번 생각하는 당신,','친환경 텀블러']})
db.type.insert_one({'type8': ['도구를 쓸 줄 아는 당신,','꿀기 텀블러']})
